...
describe('calculateDiscount', () => {
    ...
    it('should handle invalid discount code', () => {
        expect(calculateDiscount(10, 'SAVE50')).toBe(10);
    });
...
describe('validateUserInput', () => {
    it('should return a success if given valid input', () => {
        expect(validateUserInput('marsh', 42)).toMatch(/success/i); 
    });
    ...
    it('should return an error if age more than 100', () => {
        expect(validateUserInput('mosh', 101)).toMatch(/invalid/i); 
    });

    it('should return an error if both age and username are invalid', () => {
...
describe('isPriceInRange', () => {
    it.each([
        ...
        { scenario: 'price betweeen min and max', price: 50, result: true },
        { scenario: 'price = max', price: 100, result: true },
        { scenario: 'price > max', price: 200, result: false },
    ])('should returen $result when $scenario', ({ price, result }) => {
...
describe('canDrive', () => {
    ...
    ])('should return $result for age $age in $country', ({ age, country, result}) => {
